...
function TodoList() {
    ...
    function handleListItems() {
        if (task.trim()) {   // trim to remove whitespace from front and back of string
            setAddList([...addList, task])
            setTask("");
        }
    }
    // To check the task is completed or not
    ...
    function handleRemove(index) {
        ...
        afterRemove.splice(index, 1) // splice is to remove, replace and add element in array
